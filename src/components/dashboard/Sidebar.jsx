...
export default function Sidebar({ user, profile }) {
    ...
    const menuItems = {
        ...
        club_lead: [
            ...
            { name: 'About', path: '/dashboard/lead/about', icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
        ...
        admin: [
            ...
            { name: 'Verify Events', path: '/dashboard/admin/verify-events', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2v12a2 2 0 002 2z' },
            { name: 'All Events', path: '/dashboard/admin/all-events', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z' },
