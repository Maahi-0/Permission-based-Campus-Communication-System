    ...
    return (
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-10 bg-transparent">
            ...
            <div className="flex items-center gap-4">
                ...
                <button className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-gray-400 hover:text-[#0b87bd] hover:bg-[#0b87bd]/5 transition-all shadow-sm border border-white/5">
