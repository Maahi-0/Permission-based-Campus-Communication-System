                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="space-y-6">
                                {[1, 2, 3].map(i => (
                                    <div key={i} className="flex items-center gap-4 group cursor-pointer">
                                        <div className="w-12 h-12 rounded-2xl bg-[#f5f7f9] overflow-hidden">
                                            <img src={`https://api.dicebear.com/7.x/initials/svg?seed=Club${i}`} alt="club" />
                                        </div>
                                        <div className="flex-grow">
                                            <h4 className="font-black text-[#1E1E2D] text-sm group-hover:text-[#0b87bd] transition-colors">Campus Tech Club</h4>
                        ...
                        <div className="bg-gradient-to-br from-[#1E1E2D] to-black rounded-[2rem] p-8 text-white relative overflow-hidden group shadow-2xl">
                            ...
                            <button className="px-6 py-3 bg-[#0b87bd] hover:bg-[#096a96] rounded-xl text-[10px] font-black uppercase tracking-widest transition-all">
                                Go Pro
                            </button>
                        </div>
                    </div>
